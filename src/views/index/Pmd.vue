<template>
  <div class="pmd">
    <table>
      <tr>
        <td>
          ...
          <el-input v-model="pmd_title" placeholder="请输入需要查询的跑马灯标题"></el-input>
        </td>
        <td>
    ...
    <PmdDialog :dialog="dialog" @update="getProfile($event)" />
  </div>
</template>
<script>
import PmdDialog from "../../components/pmddialog/Pmddialog.vue";
